...
describe('Function sumIsLessThan100', () => {
  test('test sumIsLessThan100 1', () => {
    expect(sumIsLessThan100(11, 20)).toBe(true);
  });
  test('test sumIsLessThan100 2', () => {
    expect(sumIsLessThan100(60, 60)).toBe(false);
  });
});
